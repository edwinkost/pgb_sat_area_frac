...
class DeterministicRunner(DynamicModel):
    ...
    def dynamic(self):
        ...
        if self.modelTime.isLastDayOfMonth():
            ...
            # Method 1: Based on root zone water storage
            saturated_area_fraction_old = 1.00 - \
            ...
            # Method 2: Based on upper and lower storage
            saturated_area_fraction_new = (monthly_storUpp + monthly_storLow) / (self.storCapUpp + self.storCapLow)
            # Taking the maximum value between the two methods
            saturated_area_fraction = pcr.max(saturated_area_fraction_old, saturated_area_fraction_new)
...
def main():
    ...
    model_setup["output_dir"] = "/scratch-shared/otoo0001/test_sat_area_frac/test_09_21/"
